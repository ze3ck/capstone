            ...
            <div class="column" style="max-width: 450px;">
                ...
                <form class="ui large form" id="loginForm" method="POST">
                    ...
                    <div class="ui stacked segment">
                        ...
                        <button type="submit" class="ui fluid large teal submit button" id="loginButton">Ingresar
                        </button>
                    </div>
                </form>
...
<div class="ui modal" id="soporteModal" style="position: relative;">
    ...
    <div id="loader" class="ui active dimmer"
         style="display: none; position: absolute; top: 0; left: 0; width: 100%; height: 100%; z-index: 1000;">
    ...
    <div class="content">
        ...
        <form class="ui form" id="soporteForm">
            ...
            <div class="field">
                ...
                <textarea id="motivoSoporte" name="motivoSoporte" placeholder="Describe tu problema o pregunta"
                          required></textarea>
            </div>
        </form>
    </div>
